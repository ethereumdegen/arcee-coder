...
const config: ShaderLabConfig = {
  composition: { height: 428, width: 807 },
  layers: [
    {
      blendMode: 'normal',
    ...
    },
    {
      ...
      maskConfig: { invert: false, mode: 'multiply', source: 'luminance' },
      hue: 0,
      id: '42c3c128-ccf1-4fda-9a45-957935e439b7',
      kind: 'source',
      name: 'Image',
      opacity: 0.65,
      params: { fitMode: 'cover', scale: 0.51, offset: [-0.01, 0.32] },
      saturation: 1,
      type: 'image',
      visible: true,
      asset: { fileName: 'cool_vectors.jpg', kind: 'image', src: '/cool_vectors.jpg' },
    },
    {
      blendMode: 'normal',
      compositeMode: 'filter',
...
export default function ShaderSplash() {
